...
<body>
	...
	%>
	<!-- 나중에 post방식으로 바꾼다 -->
	<!-- title, id(올린 사람), date, location, address, unit(화폐단위), money(금액), content, identifier -->
	<form action="registerSellStep2" method="post" id="form">
		<p>
			<label>제목: </label>
		...
		<textarea name="content" id="content" rows="10" cols="70" form="form"></textarea>
		<br/>
